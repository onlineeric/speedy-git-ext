...
**Scale/Scope**: ~3 backend service methods + ~5 new RPC pairs; 2 new dialogs, 1 panel widget, 1 row badge + context menu; store map-shape change; settings plumbing. No new dependencies. Est. ~350 LOC backend, ~600 LOC webview, ~150 LOC tests.
