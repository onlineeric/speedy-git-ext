...
export function AuthorAvatar({ author, email }: AuthorAvatarProps) {
  ...
  return (
    <div
      // `text-white` is deliberate: the initials sit on a per-email hsl() background
      // generated by `utils/gravatar.ts`, which no theme token knows about. The
      // generated hues are mid-saturation, so white is the readable choice on all of them.
