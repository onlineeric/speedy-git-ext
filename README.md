...
A performance-first Git graph, Git history viewer, history-editing tool and worktrees tool built for developers who want speed, clarity, developer friendly and real Git workflow power — without the bloat.
...
| **Search and filter features** | Quickly find commits by message, hash, or author, then narrow history with branch, author, and date filters |
| **Worktrees features** | Run AI coding sessions on different branches at the same time without constantly switching your main checkout |
...
## Recent New UI and features in V5
...
| Repo support | Multi-repo switching, submodule navigation, worktree visibility | Varies | Rarely |
